...
export default function Layout({ title, description, children }) {
  ...
  return (
    <>
      <Head>
        <title>
          {title ? `${title} | CaLaNimeni` : 'CaLaNimeni'}
        </title>
      ...
      <ThemeProvider theme={theme}>
            ...
            <Grid sx={isDesktop ? classes.gridAppBar : classes.gridAppBarMobile} container spacing={1} marginTop={1} marginBottom={1}>
              <Box sx={{ gridArea: 'brand', display: 'flex', alignItems: 'center' }}>
                ...
                <NextLink href="/" passHref>
                  <Link>
                    <Typography sx={classes.brand}>CaLaNimeni</Typography>
                  </Link>
                </NextLink>
              </Box>
              <Drawer
              ...
              >
                <List sx={{ padding: 0 }}>
                  ...
                  <ListItem>
                    <Box>
                      <Typography sx={{ color: '#ffffff', fontSize: '1.1rem', fontWeight: '600' }}>La noi</Typography>
                      <NextLink href="/" passHref>
                        <Link>
                          <Typography variant="h6">ca la nimeni</Typography>
                        </Link>
                      </NextLink>
                    </Box>
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    >
                      <Typography variant="h2">Cumpărați după categorie</Typography>
                    </Box>
                  </ListItem>
        ...
        <Box component="footer" sx={classes.footer}>
          <Typography variant="subtitle2">© 2024 CaLaNimeni.</Typography>
        </Box>
      </ThemeProvider>
    </>
  )
