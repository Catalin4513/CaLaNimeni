...
export default function SearchScreen() {
  ...
  const addToCartHandler = async (product) => {
    ...
    enqueueSnackbar(`${product.name} adăugat la coș`, {
      variant: 'success',
    });
    router.push('/cart');
  };
          ...
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="lowest">Preț: mic spre mare</MenuItem>
                <MenuItem value="highest">Preț: de la mare la mic</MenuItem>
              </Select>
            </Grid>
          </Grid>
